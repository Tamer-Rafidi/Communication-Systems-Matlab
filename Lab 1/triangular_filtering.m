...
f0=900;     %fundamental freq of input triangular wave. 
T0 = 1/f0;  %period 
tstep = 0.005*T0;
...
for n = nvec
    m = n+N+1;
    %% This equation was found during in lab
    c_in(m) = 0.5*(1-cos(n*pi))/(1i*n*pi);
...
Hf = 1 ./(1+ 1.414*(1i*f/fc) + (1i*f/fc).^2) ;%filter transfer function
