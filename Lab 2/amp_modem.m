...
%message signal
% Updated value of Am with given value in lab manual
Am=-2;
fm = 1e3;
% Create tm and updated the message signal to the values given in the lab manual
tm = 0.0005;
mt = Am*sinc(tt/tm);
